...
近些年，随着计算、通信以及人工智能等技术的发展，真实世界由于其时空限制，已逐渐无法满足人类在工作、生活、娱乐等方面的需求。为此，人们开始尝试打破真实世界的物理边界，进而基于数字技术打造虚拟的数字世界。数字世界本身可看作真实世界的扩展，但相较于真实世界，数字世界可以承载人们更多的想象力与创造力。

https://user-images.githubusercontent.com/49339865/171988840-12079742-44bc-4da3-b725-8d834f0c3edf.mp4

在数字世界中，虚拟数字人将是数字世界的基本生命个体，并在数字世界运行的方方面面都扮演着核心角色，如这里所举例的数字身份、数字社交、数字场景互动以及数字世界的数字服务劳动都与虚拟数字人有着千丝万缕的关系。同时虚拟数字人在数字世界的作用也将服务于我们的真实世界，如2021年英伟达就曾基于三维数字人技术举办了一场以假乱真的产品发布会。据悉，为保证报告视频中的老黄足够真实，英伟达出动了34个3D美术师、15个软件研究人员，做了21个版本的假老黄，最终从中选择了一个最理想的。这期间英伟达整合各种三维几何建模、编辑、驱动以及渲染技术，同时借助工业级高规格采集设备，耗时良久才达到了以下视频展示的效果。

https://user-images.githubusercontent.com/49339865/171988891-8acc57a8-e2a9-4b2e-8dac-4307bd9f9897.mp4

然而，如此高昂的人力成本和时间成本、以及技术上的复杂性和专业性要求不可避免地限制了相关方法向一般消费市场的推广。另一方面，随着移动端手机设备的普及，单目RGB数据开始变得唾手可得，因此若能仅仅依赖单目RGB数据就能高效便捷自动化地获取普通对象的高质量可驱动数字化身，将极大推动虚拟数字人以及数字形象的应用与发展，而这也是三维视觉以及图形学领域一直也致力于的研究目标。

---
基于上述观察，中科大[张举勇教授](http://staff.ustc.edu.cn/~juyong/)课题组近期提出一种基于单目视频的高保真三维人体重建算法——SelfRecon，该算法仅需输入一段十几秒的目标对象的自转视频，就可恢复重建该对象的高保真数字化身。当前，相关工作已被CVPR 2022接收，并将于CVPR会议期间进行口头报告。
